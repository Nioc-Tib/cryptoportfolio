# Your own local and interactive portfolio

My goal with this project was to create a crypto portfolio that you can store on a local database (mongodb is used here).

The main benefit from that is to avoid sharing your information about your holdings with private companies such as Delta of Blockfolio.
...
Obviously this web app has not be deployed in production and require a running dev environment.
